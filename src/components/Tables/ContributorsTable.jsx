        ...
        <table className="w-full text-left text-sm">
          <thead>
            <tr className="border-b border-gray-100 bg-gray-50/50 dark:border-gray-800 dark:bg-gray-900/50">
              ...
              <th className="hidden px-5 py-3 font-medium text-gray-500 dark:text-gray-400 sm:table-cell">
                Lines Added
              </th>
              <th className="hidden px-5 py-3 font-medium text-gray-500 dark:text-gray-400 sm:table-cell">
                Lines Deleted
              </th>
              <th className="hidden px-5 py-3 font-medium text-gray-500 dark:text-gray-400 md:table-cell">
                Top Language
              </th>
              <th className="hidden px-5 py-3 font-medium text-gray-500 dark:text-gray-400 md:table-cell">
                Streak
          ...
          <tbody>
            {data.map((c, i) => (
              ...
              >
                ...
                <td className="px-5 py-3.5 font-semibold text-gray-700 dark:text-gray-300">
                  {c.totalCommits.toLocaleString()}
                </td>
                <td className="hidden px-5 py-3.5 text-emerald-600 dark:text-emerald-400 sm:table-cell">
                  +{c.linesAdded.toLocaleString()}
                </td>
                <td className="hidden px-5 py-3.5 text-red-500 dark:text-red-400 sm:table-cell">
